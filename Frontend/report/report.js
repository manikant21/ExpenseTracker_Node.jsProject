...
const BASE_URL = "http://expensetrackernodejsproject-production.up.railway.app/api/v1/report";
...
const isPremiumCheck = async () => {
    try {
        const response = await axios.get("http://expensetrackernodejsproject-production.up.railway.app/api/v1/user/status", {
...
downloadPdfBtn.addEventListener("click", async () => {
    ...
    try {
        const response = await axios.get(`http://expensetrackernodejsproject-production.up.railway.app/api/v1/report/download/pdf/${type}`, {
            responseType: "blob",
            headers: { "Authorization": token }
        });
